    ...
    return (React.createElement(SkinWrap, { style: props.style },
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, jumpLimit: props.jumpLimit, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                React.createElement("svg", { viewBox: "0 0 166.56 166.56", transform: "rotate(".concat(angle, ")"), style: { transform: "rotate(".concat(angle, "deg)") } },
...
function HighContrast(props) {
    ...
    return (React.createElement(SkinWrap, { style: props.style },
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, jumpLimit: props.jumpLimit, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                React.createElement("svg", { viewBox: "0 0 100 100", transform: "rotate(".concat(angle, ")"), style: { transform: "rotate(".concat(angle, "deg)") } },
        ...
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, jumpLimit: props.jumpLimit, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                React.createElement("svg", { viewBox: "0 0 62.463 62.463" },
                    ...
                    React.createElement("g", { transform: "translate(".concat(62.463 / 2, " ").concat(62.463 / 2, ") scale(0.45) rotate(-90)") }, Array.from(new Array(numNotches)).map(function (_, index) {
                        ...
                        return (React.createElement("rect", { key: key, id: "r".concat(index), fill: fill, width: width, height: height, x: x, y: y, transform: "rotate(".concat(index *
...
function Silver(props) {
    var _a = useAngleUpdater(props.value), angle = _a[0], setAngle = _a[1];
    var _b = useState("".concat(uniqClassName$1, "-bgr")), bgrClass = _b[0], setBgrClass = _b[1];
    var angleChangeHandler = composeTwo(setAngle, props.onAngleChange);
        ...
        React.createElement(Knob, { diameter: props.diameter + glowSpacing, value: props.value, min: props.min, max: props.max, step: props.step, jumpLimit: props.jumpLimit, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { className: "".concat(uniqClassName$1, "-rot"), style: {
                        ...
                        React.createElement("div", { className: "".concat(uniqClassName$1, "-notch"), style: {
                                left: "".concat((props.diameter - 24) / 2, "px"),
                            } })),
                    React.createElement("div", { className: "".concat(uniqClassName$1, "-text"), style: {
                            fontSize: "".concat(Math.ceil(props.diameter / 4), "px"),
                        } }, props.value)))),
        props.children));
}
...
function Donut(props) {
    var _a = useAngleUpdater(props.value), angle = _a[0], setAngle = _a[1];
    var _b = useState("".concat(uniqClassName, "-center")), centerClass = _b[0], setCenterClass = _b[1];
    var angleChangeHandler = composeTwo(setAngle, props.onAngleChange);
    var interactionChangeHandler = composeTwo(function (isInteracting) {
        isInteracting
        ...
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, jumpLimit: props.jumpLimit, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { className: uniqClassName, style: {
                            width: "".concat(props.diameter, "px"),
                            height: "".concat(props.diameter, "px"),
                            background: colorBgr,
                        } },
                        React.createElement("div", { className: "".concat(uniqClassName, "-slice-one"), style: {
                                clip: "rect(0 ".concat(props.diameter, "px ").concat(props.diameter / 2, "px 0)"),
                                transform: "rotate(".concat(angleOne, "deg)"),
                                background: colorOne,
                            } }),
                        React.createElement("div", { className: "".concat(uniqClassName, "-slice-two"), style: {
                    ...
                    React.createElement("div", { className: "".concat(uniqClassName, "-text"), style: {
                            color: donutColor,
                            fontSize: "".concat(Math.ceil(props.diameter / 4), "px"),
                        } }, props.value)))),
        props.children));
...
export { Basic, Donut, HighContrast, Silver, SkinWrap, White, composeTwo, Knob as default, useAngleUpdater };
